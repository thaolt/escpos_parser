...
#define VECTOR_TYPE escpos_token_t*
#define VECTOR_NAME token

#ifndef VECTOR_PREFIX
#define VECTOR_PREFIX escpos_vec
#endif
...
static __inline VECTOR_TYPE VECTOR_GET(VECTOR vec, int i) { return vec[0].arr[i]; }
...
static __inline size_t VECTOR_SIZE(VECTOR vec) { return vec[0].size; }
